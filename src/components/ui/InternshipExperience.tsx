...
const experiences = [
  ...
  },
  {
    ...
    title: "跨系统接口与数据流转规划",
    details: [
      "梳理网点备件系统与外部中台系统的底层交互方案设计，并制定跨系统数据字典。",
      "独立梳理并定义了“工单触发 - 库存扣减 - 领用出库”全环节的数个核心接口逻辑。",
      "严密规划各种异常流回退机制，从产品源头保障了复杂业务流转下的账实一致性，实现与研发团队的零歧义交接。"
    ]
  },
  {
    ...
    details: [
      ...
      "针对 Web 端与 App 端跨端协同的复杂性，详细梳理并校验多角色权限机制。",
      "严密规划工单状态机流转逻辑，确保长周期、多节点服务工单的状态闭环可控。"
    ]
  },
  {
    icon: <FileText className="w-6 h-6" />,
    title: "O2O 服务工单闭环与 UAT 验收",
    details: [
      "独立负责 P0 阶段工单模块的全链路业务交付与 UAT（用户验收测试）。",
      "在测试交付阶段前置拦截关键业务阻断点，消除业务断层隐患。",
      "有力保障了美的售后核心派单网络的高质量交付与平稳上线。"
    ]
  }
];
